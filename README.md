...
You can copy the history_timestamp.sh file from this site or you can write your own. [📥 Download history_timestamp.sh](https://github.com/ErikFW/LinuxHistoryTimestamp/releases)
 <br>
